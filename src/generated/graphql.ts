...
function fetcher<TData, TVariables>(query: string, variables?: TVariables) {
  return async (): Promise<TData> => {
    const res = await fetch("https://fakeql.com/graphql/76166bede3baf5c6646be7f6d82aebf4", {
    method: "POST",
...
export type PostsQuery = { __typename?: 'Query', posts?: Array<{ __typename?: 'Post', id: string, title: string } | null> | null };
